    ...
    <main className="flex-1 p-8 overflow-y-auto">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-4xl font-extrabold text-gray-900">Project Dashboard</h1>
          ...
          <div className="flex flex-col items-end">
            <div className="flex items-center gap-2 flex-shrink-0">
              <button 
                onClick={handleSave}
                disabled={!storyboard}
                className="bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-300 disabled:cursor-not-allowed text-white font-semibold py-2 px-4 border border-transparent rounded-lg shadow-sm inline-flex items-center gap-2 transition-colors">
              ...
              <button 
                ...
                disabled={!storyboard}
                className="bg-white hover:bg-gray-100 disabled:bg-gray-100 disabled:cursor-not-allowed disabled:text-gray-400 text-gray-800 font-semibold py-2 px-4 border border-gray-300 rounded-lg shadow-sm inline-flex items-center gap-2 transition-colors">
            ...
            <div className="flex flex-col items-center justify-center min-h-96">
              {progress ? (
                ...
                <>
                  ...
                  <p className="mt-4 text-lg font-semibold text-gray-700">Generating your masterpiece...</p>
