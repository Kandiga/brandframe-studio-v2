  ...
  return (
    <main className="flex-1 p-8 overflow-y-auto">
      <div className="max-w-7xl mx-auto">
        ...
        {projects.length === 0 ? (
          <div className="mt-10 flex flex-col items-center justify-center text-center h-[60vh] bg-white p-6 rounded-xl shadow-lg">
            <MyProjectsIcon className="w-16 h-16 text-gray-300" />
            <p className="mt-4 text-lg font-semibold text-gray-700">No projects yet</p>
